...
public class ExponentiationTest {
    ...
    public void recusriveExponentiationTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++)
            assertEquals((long) expectedResultList.get(i), (long) Exponentiation.recursiveExponentiation(baseList.get(i), exponentList.get(i)));
    }
    ...
    public void fastRecusriveExponentiationTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++)
            assertEquals((long) expectedResultList.get(i),(long)  Exponentiation.fastRecursiveExponentiation(baseList.get(i), exponentList.get(i)));
    }
    ...
    public void fastRecusriveExponentiationModuloTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++)
            assertEquals((long) expectedResultList.get(i), (long) Exponentiation.fastRecursiveExponentiationModulo(baseList.get(i), exponentList.get(i), divisorList.get(i)));
    }
}
